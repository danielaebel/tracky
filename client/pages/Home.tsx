...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-start h-screen bg-white max-w-[402px] mx-auto">
      <div className="flex items-center gap-3 px-3 py-0 w-full border-b border-[#F5F5F5] bg-white">
        <button className="flex items-center justify-center w-[60px] h-[60px] p-4.5 rounded-lg">
